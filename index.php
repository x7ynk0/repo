...
<section class="filter-bar" id="urunler">
    <div class="container">
        <form method="get" action="index.php#urunler" class="filter-form">
            <div class="filter-field grow">
                <label for="f-q">Parça Ara</label>
                <input type="text" id="f-q" name="q" value="<?= e($q) ?>" placeholder="Parça adı, OEM / parça kodu...">
            </div>
...
<section class="products-section">
    <div class="container">
        <div class="section-head">
            <h2><?= $hasFilter ? 'Arama Sonuçları' : 'Ürünler' ?></h2>
